...
module.exports = BaseTypes => {
  ...
  BaseTypes.DATE.types['better-sqlite'] = ['DATETIME'];
  BaseTypes.STRING.types['better-sqlite'] = ['VARCHAR', 'VARCHAR BINARY'];
  BaseTypes.CHAR.types['better-sqlite'] = ['CHAR', 'CHAR BINARY'];
  BaseTypes.TEXT.types['better-sqlite'] = ['TEXT'];
  BaseTypes.TINYINT.types['better-sqlite'] = ['TINYINT'];
  BaseTypes.SMALLINT.types['better-sqlite'] = ['SMALLINT'];
  BaseTypes.MEDIUMINT.types['better-sqlite'] = ['MEDIUMINT'];
  BaseTypes.INTEGER.types['better-sqlite'] = ['INTEGER'];
  BaseTypes.BIGINT.types['better-sqlite'] = ['BIGINT'];
  BaseTypes.FLOAT.types['better-sqlite'] = ['FLOAT'];
  BaseTypes.TIME.types['better-sqlite'] = ['TIME'];
  BaseTypes.DATEONLY.types['better-sqlite'] = ['DATE'];
  BaseTypes.BOOLEAN.types['better-sqlite'] = ['TINYINT'];
  BaseTypes.BLOB.types['better-sqlite'] = ['TINYBLOB', 'BLOB', 'LONGBLOB'];
  BaseTypes.DECIMAL.types['better-sqlite'] = ['DECIMAL'];
  BaseTypes.UUID.types['better-sqlite'] = ['UUID'];
  BaseTypes.ENUM.types['better-sqlite'] = false;
  BaseTypes.REAL.types['better-sqlite'] = ['REAL'];
  BaseTypes.DOUBLE.types['better-sqlite'] = ['DOUBLE PRECISION'];
  BaseTypes.GEOMETRY.types['better-sqlite'] = false;
  BaseTypes.JSON.types['better-sqlite'] = ['JSON', 'JSONB'];
